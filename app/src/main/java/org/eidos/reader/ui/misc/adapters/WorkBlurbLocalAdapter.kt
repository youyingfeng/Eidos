...
/*
Adapter to translate WorkBlurb data to full work blurb views.
 */
...
class WorkBlurbLocalAdapter
    ...
    : ListAdapter<WorkBlurb, WorkBlurbLocalAdapter.WorkBlurbLocalViewHolder>(WorkBlurbDiffCallback)
{
